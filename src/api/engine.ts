...
export const startEngineApi = async (id: number): Promise<EngineStartResponse> => {
...
export const driveApi = async (id: number): Promise<{ success: true }> => {
...
export const stopEngineApi = async (id: number): Promise<EngineStartResponse> => {
